...
class TranscriptionRouter(BaseRouter):
    ...
    def setup_routes(self):
        self.app.add_url_rule(
            "/transcription", 
            "transcribe",
            view_func=lambda: self.transcribe_controller.validate_transcription_data(request),
            methods=["POST"]
        )
        ...
        self.app.add_url_rule(
            ...
            view_func=lambda job_id: self.transcribe_controller.get_transcription_status(job_id),
            methods=["GET"]
        )
        ...
        self.app.add_url_rule(
            ...
            view_func=lambda artist, album, title, version: 
                self.transcribe_controller.approve_transcription(artist, album, title, version),
            methods=["POST"]
        ) 