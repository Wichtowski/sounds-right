...
class StorageRepository:
    def __init__(self):
        ...
        try:
            ...
            raise Exception("Google Cloud credentials not found. Please set up Application Default Credentials by running 'gcloud auth application-default login'.")
    ...
    def upload_file(self, file: FileStorage, artist: str, album: str, title: str) -> str:
        """
    ...
    def upload_file_object(self, file_object: BytesIO, artist: str, album: str, title: str, filename: str, content_type: str) -> str:
        """
    ...
    def move_approved_transcription(self, artist: str, album: str, title: str, version: int) -> dict:
        """
        ...
        if not blobs:
            raise FileNotFoundError(f"No files found in review bucket at {source_prefix}")
        ...
        for source_blob in blobs:
            ...
            # Store the new URL
            moved_files[os.path.basename(file_name)] = f"gs://{self.production_bucket}/{file_name}"
